...
<p class="breadcrumbs"><a href="http://www.fosterskills.org/home.html" class="breadcrumbs">Foster Skills</a>
 &gt; <a href="http://www.fosterskills.org/get_involved.html" class="breadcrumbs">Get Involved</a>
  &gt; <a href="http://www.fosterskills.org/get_involved/partners.html" class="breadcrumbs">Partners</a></p></div>

<h2 class="main-text"><br>
Header2</h2>
<p class="main-text"><br>

<br><strong style="font-weight: bold">Bold Text</strong></p>
</div> <!-- END RIGHT MAIN -->
</div> <!-- END MAIN -->
